defmodule LiveViewStudio.DonationsTest do
  ...
  describe "donations" do
    ...
    @valid_attrs %{days_until_expires: 42, emoji: "some emoji", item: "some item", qunatity: 42}
    @update_attrs %{days_until_expires: 43, emoji: "some updated emoji", item: "some updated item", qunatity: 43}
